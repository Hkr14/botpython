...
mongourl = 'mongodb+srv://Triplehkr:C0m0erl.@cluster0.tygec8c.mongodb.net/?retryWrites=true&w=majority'
client = pymongo.MongoClient(mongourl,serverSelectionTimeoutMS=5000)
maindb = client.bot['main']

antidb = redis.Redis(host='http://redis-15224.c284.us-east1-2.gce.cloud.redislabs.com:15224', port=15224REDIS_PASS, password='7uqkU7tRhgE3bU9DHIxTpgowVJJiu3Cz')
