...
async def buy(Client, message , update):
  buttons = [
    [
        ...
        InlineKeyboardButton('ℹ CHANNEL ℹ', url='https://t.me/MarGrupoVip')
    ],
    [
        InlineKeyboardButton('↩️ RETURN ↩️', callback_data='gates'),
        InlineKeyboardButton('🚪 CLOSE 🚪', callback_data='close')
...
<b>○</b> <b>10$</b>: <b>250 Credits</b> || <b>Access all gates</b>
<b>○</b> <b>25$</b>: <b>600 Credits</b> || <b>Access all gates</b>
<b>○</b> <b>35$</b>: <b>1500 Credits</b> || <b>Access all gates</b>
<b>○</b> <b>45$</b>: <b>3000 Credits</b> || <b>Access all gates</b>
<b>📢</b> <b><i>buy your credits by bank transfer</i></b>
"""
  await Client.edit_message_text(
      chat_id=message.chat.id,
      text=text,
